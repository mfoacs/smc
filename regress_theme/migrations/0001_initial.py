...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'regress_theme_homepageslide', (
        ...
        db.send_create_signal(u'regress_theme', ['HomePageSlide'])


    def backwards(self, orm):
        # Deleting model 'HomePageSlide'
        db.delete_table(u'regress_theme_homepageslide')
    ...
    models = {
        ...
        u'regress_theme.homepageslide': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'HomePageSlide'},
